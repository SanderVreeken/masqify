    ...
    <div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Inter', system-ui, sans-serif; background-color: #ffffff;">
      ...
      <div style="padding: 40px 32px 32px; text-align: center; border-bottom: 1px solid #e5e7eb;">
        <div style="margin-bottom: 16px;">
          <img src="${process.env.APP_URL || process.env.NEXT_PUBLIC_APP_URL || 'https://masqify.io'}/masqify-logo.svg" alt="Masqify" width="48" height="48" style="display: inline-block;"/>
        </div>
      ...
      <div style="padding: 40px 32px;">
        <h2 style="color: #111827; font-size: 20px; font-weight: 600; margin: 0 0 24px 0;">Reset Your Password</h2>
        ...
        <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 32px 0;">
          We received a request to reset your password. Click the button below to create a new password for your Masqify account.
        </p>
