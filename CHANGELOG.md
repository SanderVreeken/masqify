...
### Added
- Added iDEAL payment method support to Stripe checkout for European customers, particularly in the Netherlands
...
### Fixed
- Fixed payment webhook processing error caused by missing `completedAt` field in database insert query (lib/balance.ts:128)
